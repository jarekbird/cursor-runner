...
# Note: Pre-installing @modelcontextprotocol/server-atlassian to avoid npx download delays
RUN npm install -g mcp-server-sqlite-npx @liangshanli/mcp-server-redis @modelcontextprotocol/server-atlassian && \
